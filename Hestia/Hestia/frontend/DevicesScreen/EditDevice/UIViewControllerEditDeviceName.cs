...
namespace Hestia.DevicesScreen.EditDevice
{
    public class UIViewControllerEditDeviceName : UIViewController
    {
        ...
        public override void ViewDidLoad()
        {
            ...
            // Rectangular cell displaying the label and inputfield
            UIView rectangle2 = new UIView(new CGRect(0, 140, this.View.Bounds.Width, 50));
            ...
            // Rectangular cell displaying the label and inputfield
            UIView rectangle3 = new UIView(new CGRect(0, 190, this.View.Bounds.Width, 50));
            ...
            this.View.BackgroundColor = UIColor.FromWhiteAlpha(0.9f, 1f);
            Title = device.Name;
